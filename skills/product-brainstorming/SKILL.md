...
Số liệu/claim phải có nguồn hoặc `[chưa verify]`/`[giả định]`. Không bịa fact nội bộ NDS/VisibilityPRO — dùng NDS-Knowledge hoặc flag cho discovery. (khớp `shared/pushback-triggers.md`.)
